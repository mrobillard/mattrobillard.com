...
export const pseudo = (props) => {
    return css({
        ...
        '&[disabled=true],&[aria-disabled=true],&[data-disabled=true]': props._disabled,
        ...
        '&:indeterminate,&[aria-checked=mixed],&[data-indeterminate=true]': props._indeterminate,
...
export const style = compose(space, color, typography, layout, flexbox, grid, background, border, position, shadow, other);
